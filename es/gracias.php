...
<body onload="document.getElementById('iuser_waiting').style.display='none'">
  <?php
if (isset($_SESSION['NumCliente']) && isset($_SESSION['TimeCompra'])) { ?>
    ...
    <div id="wrapper" class="container">
      ...
      <section class="row">
        <?php include ('../gadgets/iuser_cliente/sc_gracias.php');
        ?>
      </section>

<?php  }else if(isset($_SESSION['NumCliente']) && !isset($_SESSION['TimeCompra'])){
